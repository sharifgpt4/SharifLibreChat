...
const dataProvider = {
    getList: async (resource, params) => {
        ...
        const url = `${apiUrl}/${resource}/get_all_users?${new URLSearchParams(query)}`;
    ...
    getMany: async (resource, params) => {
        ...
        const { data } = await httpClient(`${apiUrl}/${resource}/get_many?${new URLSearchParams(query)}`);
        return { data };
    },
    ...
    create: async (resource, params) => {
        ...
        return { data: data.user }; // Directly use the user object from the response
    },
